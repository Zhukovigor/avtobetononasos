...
const sany750SData: ProductData = {
  model: "SANY SYM5552THB 750S",
  title: "SANY SYM5552THB 750S",
  subtitle: "Премиальный автобетононасос с высотой подачи 75 метров",
  ...
  specifications: {
    general: [
      { icon: <Ruler className="w-4 h-4" />, label: "Длина", value: "17 200 мм", highlight: false },
      ...
      { icon: <Weight className="w-4 h-4" />, label: "Масса", value: "56 000 кг", highlight: true },
    ],
    boom: [
      { icon: <ArrowUp className="w-4 h-4" />, label: "Вертикальный вылет", value: "75.0 м", highlight: true },
      { icon: <ArrowRight className="w-4 h-4" />, label: "Горизонтальный вылет", value: "68.5 м", highlight: true },
      { icon: <ArrowDown className="w-4 h-4" />, label: "Глубина подачи", value: "58.5 м", highlight: false },
      { icon: <Target className="w-4 h-4" />, label: "Минимальный радиус", value: "9.0 м", highlight: false },
    ],
    pump: [
      { icon: <Activity className="w-4 h-4" />, label: "Производительность", value: "180 м³/ч", highlight: true },
      { icon: <Gauge className="w-4 h-4" />, label: "Давление бетона", value: "9.5 МПа", highlight: false },
  ...
  features: [
    "Максимальная высота подачи 75 метров",
    "Премиальная система управления",
    "Усиленная 7-секционная стрела",
    "Система автоматической балансировки",
    "Интеллектуальная диагностика",
    "Система экстренного торможения",
  ],
  advantages: [
    "Лидер по высоте подачи в России",
  ...
  pdfData: {
    ...
    specs: {
      ...
      height: "4 000 мм",
      weight: "56 000 кг",
      verticalReach: "75.0 м",
      horizontalReach: "68.5 м",
      depthReach: "58.5 м",
      minRadius: "9.0 м",
...
export default function Sany750SClientPage() {
  return <ProductPage data={sany750SData} />
}
