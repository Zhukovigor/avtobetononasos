          ...
          <div className="flex items-center space-x-3">
            ...
            {isAdmin ? (
              <button
                ...
                className="group relative overflow-hidden bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg flex items-center space-x-2"
              >
              ...
              <button
                ...
                className="group relative overflow-hidden bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg flex items-center space-x-2"
              >
